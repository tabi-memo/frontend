    ...
    <>
      ...
      { !activityData || loading ? (
        ...
        <Box minHeight="100vh" as="main" bg={bg} color={color}>
          ...
          >
            <ActivityHeader title={activityData.title} time_from={activityData.time_from} time_to={activityData?.time_to} address={activityData?.address} url={activityData?.url} />
